...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function model = ex5_1_TX_grid()
    model.Name='ex5_1_TX_grid';
    % TL grid, two DNAs, measuring two different mrnas, and proteins
    % later we can optionally change N0 and AA0
    
    %
    % Here we fix the RNA degradation numbers and tx parameters (assuming they are known from
    ...
    g11 = 0; g12 = 0; g13=0;  g14 = 0; g15=0;         % Controls
